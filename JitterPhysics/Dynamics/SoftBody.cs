...
namespace Jitter.Dynamics
{
    public partial class SoftBody : IBroadphaseEntity
    {
        ...
        public SoftBody(int sizeX,int sizeY, float scale)
        {
            ...
            this.EdgeSprings  = new ReadOnlyCollection<Spring>(springs);
            this.VertexBodies = new ReadOnlyCollection<MassPoint>(points);
            this.Triangles    = new ReadOnlyCollection<Triangle>(triangles);
